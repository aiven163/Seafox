...
public abstract class Request<T> implements Comparable<Request<T>> {
	 ...
	 *
	 * @deprecated Use {@link #Request(int, String,  com.aiven.seafox.controller.http.volley.Response.ErrorListener)}.
	 */
	@Deprecated
	...
	/**
	 * @return this request's {@link  com.aiven.seafox.controller.http.volley.Response.ErrorListener}.
	 */
	...
	private static String createIdentifier(final int method, final String url) {
		return InternalUtils.sha1Hash("Request:" + method + ":" + url + ":" + System.currentTimeMillis() + ":"
				+ (sCounter++));
	}
